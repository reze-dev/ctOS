          ...
          config = {
            programs.kitty = {
              ...
              extraConfig = ''
                ...
                font_family family='MonoLisa' style=Regular features="+calt +liga +salt +ss07 +ss08"
                bold_font        auto
                italic_font family='MonoLisa Italic' style=Regular features="+calt +liga +salt +ss02 +ss07 +ss08"
